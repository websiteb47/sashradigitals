        ...
        <div className="max-w-6xl mx-auto px-4 md:px-10 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 flex flex-col items-center lg:items-start w-full">
              {/* Feature 1 */}
              <div className="why-choose-card group flex items-start gap-6 p-6 rounded-2xl bg-slate-800/50 backdrop-blur-sm shadow-lg hover:shadow-xl hover:scale-105 hover:-translate-y-1 transition-all duration-700 transform opacity-0 animate-fade-in-left w-full max-w-md lg:max-w-none">
              ...
              {/* Feature 2 */}
              <div className="why-choose-card group flex items-start gap-6 p-6 rounded-2xl bg-slate-800/50 backdrop-blur-sm shadow-lg hover:shadow-xl hover:scale-105 hover:-translate-y-1 transition-all duration-700 transform opacity-0 animate-fade-in-left w-full max-w-md lg:max-w-none" style={{animationDelay: '0.2s'}}>
              ...
              {/* Feature 3 */}
              <div className="why-choose-card group flex items-start gap-6 p-6 rounded-2xl bg-slate-800/50 backdrop-blur-sm shadow-lg hover:shadow-xl hover:scale-105 hover:-translate-y-1 transition-all duration-700 transform opacity-0 animate-fade-in-left w-full max-w-md lg:max-w-none" style={{animationDelay: '0.4s'}}>
              ...
              {/* Feature 4 */}
              <div className="why-choose-card group flex items-start gap-6 p-6 rounded-2xl bg-slate-800/50 backdrop-blur-sm shadow-lg hover:shadow-xl hover:scale-105 hover:-translate-y-1 transition-all duration-700 transform opacity-0 animate-fade-in-left w-full max-w-md lg:max-w-none" style={{animationDelay: '0.6s'}}>
            ...
            <div className="relative opacity-0 animate-fade-in-right flex justify-center lg:justify-start">
              {/* Background Decorative Elements */}
